      ...
      <div className='infoSection_toolBar'>
        <div className='infoSection_toolIcons'>
          <svg
            x='0'
            y='0'
            className='infoSection_notificationIcon'
            aria-hidden='false'
            width='24'
            height='24'
            viewBox='0 0 24 24'
          ...
          <svg
            x='0'
            y='0'
            className='infoSection_fastenerIcon'
            aria-hidden='false'
            width='24'
            height='24'
            viewBox='0 0 24 24'
          ...
          <svg
            x='0'
            y='0'
            className='infoSection_peoplesIcon'
            aria-hidden='false'
            width='24'
            height='24'
            viewBox='0 0 24 24'
        ...
        >
          <div
            class='iconWrapper-2OrFZ1 clickable-3rdHwn'
            role='button'
            aria-label='Yardım'
            tabindex='0'
          >
            <svg
              x='0'
              y='0'
              className='infoSection_messagesComeIcon'
              aria-hidden='false'
              width='24'
              height='24'
              viewBox='0 0 24 24'
            ...
            <svg
              x='0'
              y='0'
              className='infoSection_infoIcon'
              aria-hidden='false'
              width='24'
              height='24'
              viewBox='0 0 24 24'
