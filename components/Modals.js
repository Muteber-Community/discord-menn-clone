...
ChannelSettingsModal = ({ channelArrowHandler }) => {
  return (
    <div className='channelSettingsModal_layer'>
      <div
        onClick={channelArrowHandler}
        className='channelSettingsModal_background'
      ></div>
...
AddChannelModal = ({ addServerHandler }) => {
  ...
  if (activeModal == 'addChannelModal') {
    return (
      <>
        <div className='addChannelModal_layer'>
          ...
          <div className='addChannelModal' id='addChannelModal'>
            ...
            <div className='addChannelModal_content'>
              <div
                onClick={() => {
                  setActiveModal('letMeCreateChannelModal');
                }}
  ...
  if (activeModal == 'letMeCreateChannelModal') {
    return (
      <div className='addChannelModal_layer'>
        <div
          onClick={addServerHandler}
          className='addChannelModal_background'
        ></div>
        <div className='letMeCreateChannelModal' id='letMeCreateChannelModal'>
          <div className='letMeCreateChannelModal_upper'>
            <h2>Bir sunucu oluştur</h2>
            <div
              // onClick={addServerHandler}
              className='addChannelModal_closeButton'
