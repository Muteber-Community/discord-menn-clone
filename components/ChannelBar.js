...
const ChannelBar = () => {
  ...
  return (
    <div className='channelBar'>
      ...
      <div className='listItem'>
        <div className="channelIcon_effect">
          <div onClick={e => addServerHandler(e)} className={isAddServerModalActive ? "channelIcon_active" : "channelIcon"} id={isAddServerModalActive ? "addServer_active" : "addServer"}>
        ...
        <div className={isAddServerModalActive ? "listItem-left_active" : "listItem-left"}/>
      </div>
